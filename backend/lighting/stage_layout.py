...
LAYOUTS: dict[str, dict] = {
    ...
    "festival_lite": {
        ...
        "fixtures": [
            ...
            {"id": "laser_oh_l",  "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead",
             "position": [-4.0, 8.0, -5.0], "aim": [ 0.22, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 65, "beam_length": 18.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 40, "label": "Laser L"},
            {"id": "laser_oh_r",  "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead",
             "position": [ 4.0, 8.0, -5.0], "aim": [-0.22, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 65, "beam_length": 18.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 40, "label": "Laser R"},
            {"id": "laser_oh_c",  "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead",
             "position": [ 0.0, 8.0, -1.5], "aim": [ 0.0,  0.0, 1.0],
             "beam_angle": 1, "scan_angle": 55, "beam_length": 14.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 35, "label": "Laser C"},
        ],
        "viewer_hint": {
            "viewer_position":  [0.0,  4.0, 14.0],
            "viewer_lookat":    [0.0,  3.0, -2.0],
            "stage_back_z":    -9.0,
            "audience_front_z": 12.0,
        },
        "stage_markers": [
            {
                "id":       "label_stage",
    ...
    "mobile_dj": {
        ...
        "fixtures": [
            ...
            {"id": "laser_oh_l", "group": "lasers", "type": "laser_rgb",
             ...
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 25, "label": "Laser L"},
            {"id": "laser_oh_r", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead",
             "position": [ 0.8, 2.3,  0.3], "aim": [ 0.12, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 30, "beam_length": 5.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 25, "label": "Laser R"},
        ],
        "viewer_hint": {
