...
LAYOUTS: dict[str, dict] = {
    ...
    "small_club": {
        ...
        "fixtures": [
            ...
            # Overhead truss lasers — purely horizontal aims, beams travel through haze
            # Y component is 0: beams never descend toward the floor plane.
            # beam_length caps the ray; renderer must NOT extend beyond it.
            {"id": "laser_oh_l",  "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead",
             "position": [-1.5, 3.9, -0.8], "aim": [-0.18, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 45, "beam_length": 7.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 30,
             "sweep_role": "left", "sweep_phase_offset_deg": 0,
             "mirror_of": "laser_oh_r",
             "label": "Laser L"},
            {"id": "laser_oh_c",  "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead",
             "position": [ 0.0, 3.9, -0.8], "aim": [ 0.0,  0.0, 1.0],
             "beam_angle": 1, "scan_angle": 45, "beam_length": 7.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 30,
             "sweep_role": "center", "sweep_phase_offset_deg": 0,
             "label": "Laser C"},
            {"id": "laser_oh_r",  "group": "lasers", "type": "laser_rgb",
             ...
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 30,
             "sweep_role": "right", "sweep_phase_offset_deg": 180,
             "mirror_of": "laser_oh_l",
             "label": "Laser R"},
        ],
        # ── Orientation markers ─────────────────────────────────────────────
        # viewer_hint: camera looks from +Z toward -Z (audience → stage).
        # stage_back_z is the Z coordinate of the upstage wall.
        "viewer_hint": {
            "viewer_position":  [0.0,  2.0,  6.0],
            "viewer_lookat":    [0.0,  1.5, -1.0],
            "stage_back_z":    -4.5,
            "audience_front_z": 5.0,
        },
        "stage_markers": [
            {
                "id":       "label_stage",
                "text":     "STAGE",
                "position": [0.0, 0.05, -4.0],   # just above floor, upstage centre
                "font_size": 0.55,                 # metres tall
                "opacity":   0.22,                 # very subtle
                "color":     "#ffffff",
                "face_axis": "+Z",                 # text faces viewer (toward +Z)
            },
        ],
    },
    ...
    "festival_lite": {
        ...
        "fixtures": [
            ...
            # ── Festival laser zones — top truss (3 units) ──────────────────
            {"id": "laser_top_l", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead", "zone_class": "overhead",
             "position": [-5.0, 7.8, -1.5], "aim": [-0.20, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 55, "beam_length": 16.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 35,
             "sweep_role": "left", "sweep_phase_offset_deg": 0,
             "mirror_of": "laser_top_r",
             "label": "Top L"},
            {"id": "laser_top_c", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead", "zone_class": "overhead",
             "position": [ 0.0, 7.8, -1.5], "aim": [ 0.00, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 45, "beam_length": 14.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 30,
             "sweep_role": "center", "sweep_phase_offset_deg": 0,
             "label": "Top C"},
            {"id": "laser_top_r", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead", "zone_class": "overhead",
             "position": [ 5.0, 7.8, -1.5], "aim": [ 0.20, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 55, "beam_length": 16.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 35,
             "sweep_role": "right", "sweep_phase_offset_deg": 180,
             "mirror_of": "laser_top_l",
             "label": "Top R"},
            # ── Floor upstage (3 units) — aim upward into haze ──────────────
            {"id": "laser_floor_l", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "floor_upstage", "zone_class": "floor",
             "position": [-4.0, 0.3, -8.0], "aim": [-0.10, 0.28, 1.0],
             "beam_angle": 1, "scan_angle": 40, "beam_length": 14.0,
             "scan_axes": ["horizontal", "vertical"],
             "tilt_range_deg": 25,
             "sweep_role": "left", "sweep_phase_offset_deg": 0,
             "mirror_of": "laser_floor_r",
             "label": "Floor L"},
            {"id": "laser_floor_c", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "floor_upstage", "zone_class": "floor",
             "position": [ 0.0, 0.3, -8.0], "aim": [ 0.00, 0.28, 1.0],
             "beam_angle": 1, "scan_angle": 30, "beam_length": 12.0,
             "scan_axes": ["horizontal", "vertical"],
             "tilt_range_deg": 20,
             "sweep_role": "center", "sweep_phase_offset_deg": 0,
             "label": "Floor C"},
            {"id": "laser_floor_r", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "floor_upstage", "zone_class": "floor",
             "position": [ 4.0, 0.3, -8.0], "aim": [ 0.10, 0.28, 1.0],
             "beam_angle": 1, "scan_angle": 40, "beam_length": 14.0,
             "scan_axes": ["horizontal", "vertical"],
             "tilt_range_deg": 25,
             "sweep_role": "right", "sweep_phase_offset_deg": 180,
             "mirror_of": "laser_floor_l",
             "label": "Floor R"},
            # ── Side towers (2 units) — cross-stage geometry ─────────────────
            {"id": "laser_side_l", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "side_tower", "zone_class": "side_tower",
             "position": [-7.5, 3.5, -3.0], "aim": [ 0.55, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 50, "beam_length": 16.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 35,
             "sweep_role": "left", "sweep_phase_offset_deg": 0,
             "mirror_of": "laser_side_r",
             "label": "Side L"},
            {"id": "laser_side_r", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "side_tower", "zone_class": "side_tower",
             "position": [ 7.5, 3.5, -3.0], "aim": [-0.55, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 50, "beam_length": 16.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 35,
             "sweep_role": "right", "sweep_phase_offset_deg": 180,
             "mirror_of": "laser_side_l",
             "label": "Side R"},
        ],
        "viewer_hint": {
            "viewer_position":  [0.0,  5.0, 16.0],
            "viewer_lookat":    [0.0,  3.5, -3.0],
            "stage_back_z":    -9.5,
            "audience_front_z": 14.0,
        },
        "stage_markers": [
            {
                "id":       "label_stage",
    ...
    "mobile_dj": {
        ...
        "fixtures": [
            ...
            {"id": "laser_oh_l", "group": "lasers", "type": "laser_rgb",
             "emission_zone": "overhead",
             "position": [-0.8, 2.3,  0.3], "aim": [-0.12, 0.0, 1.0],
             "beam_angle": 1, "scan_angle": 30, "beam_length": 5.0,
             "scan_axes": ["horizontal", "vertical", "diagonal"],
             "tilt_range_deg": 25,
             "sweep_role": "left", "sweep_phase_offset_deg": 0,
             "mirror_of": "laser_oh_r",
        ...
        "viewer_hint": {
            "viewer_position":  [0.0,  1.5,  4.0],
            "viewer_lookat":    [0.0,  1.0, -0.5],
            "stage_back_z":    -2.5,
            "audience_front_z": 3.5,
        },
        "stage_markers": [
            {
                "id":       "label_stage",
                "text":     "STAGE",
                "position": [0.0, 0.05, -2.0],
                "font_size": 0.30,
                "opacity":   0.22,
                "color":     "#ffffff",
                "face_axis": "+Z",
